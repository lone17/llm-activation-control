# curl 0.0.0.0:9900/angular_steering/none \
...
for task in "${TASKS[@]}"; do
    ...
    lm_eval \
        ...
        --output_path /home/ian/repos/llm-activation-control/benchmarks/max_norm/${task}/${model_name}/adaptive_none \
        --wandb_args project=lm-eval-angular-steering,entity=lone17,id=${model_name}+${task}+adaptive_none+max_norm \
        --log_samples
    ...
    for angle in $(seq 0 10 350); do
        ...
        lm_eval \
            ...
            --output_path /home/ian/repos/llm-activation-control/benchmarks/max_norm/${task}/${model_name}/adaptive_${angle} \
            --wandb_args project=lm-eval-angular-steering,entity=lone17,id=${model_name}+${task}+adaptive_${angle}+max_norm \
            --log_samples
    done
done
...
#         # --model_args model=${model_id},base_url=http://0.0.0.0:8011/v1/completions,num_concurrent=1,max_retries=3,tokenized_requests=False \
#         --output_path /home/ian/repos/llm-activation-control/output/${model_name}/tinyHellaswag/adaptive_none
